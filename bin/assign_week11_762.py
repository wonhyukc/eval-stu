...
def main():
    ...
    print(f"✅ 11주차 web 02 (762) 제출자 수: {len(wb_submitters)}명")
    ...
    out_md = os.path.join(base_dir, "9output", "week11_peer_review_assignments_762.md")
    with open(out_md, "w", encoding="utf-8") as f:
        f.write(
            "# Week 11 Peer Review Assignments / 11주차 상호평가 배당표 (Track 762 / web)\n\n"
        )
    ...
    print(f"✅ 마크다운 생성 완료: 9output/week11_peer_review_assignments_762.md")
