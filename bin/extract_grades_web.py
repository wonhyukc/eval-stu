...
from modules.sheet_updater_web import append_grades_to_sheet
...
def extract_grades(query=None, require_attachment=False, lang="ko"):
    ...
    for email_data in emails:
        ...
        # 웹 과제 채점이므로 트랙이 761 또는 762가 아니면 제외
        if track_num not in ["761", "762"]:
            continue
    ...
    output_path = os.path.join(base_dir, "9output", "grades_output_web.csv")
